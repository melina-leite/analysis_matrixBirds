---
title: "Appendix S4: Robustness analysis with species that occur at both high and low-quality landscapes"
author: "Melina Leite"
...
classoption: a4paper
header-includes:
    - \renewcommand{\figurename}{Figure S4.}
    - \makeatletter
    - \def\fnum@figure{\figurename\thefigure}
    - \makeatother
    - \renewcommand{\tablename}{Table S4.}
    - \makeatletter
...
```{r fig_gen, fig.height=18,fig.width=11, fig.cap="Predictions for habitat generalist birds."}
pred.gen %>%
  mutate(forest_site400Orig = round(forest_site400Orig)) %>%
  ggplot(aes(x=forest_site400Orig, y=pretes, col=`Matrix quality`,
             linetype=dataset)) +
