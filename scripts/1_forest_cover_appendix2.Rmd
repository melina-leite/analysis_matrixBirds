---
title: 'Appendix 2: Landscapes Landuse and forest cover at local and landscape scale'
author: "Melina Leite"
...
To compare landuse matrices in both high- and low-quality landscapes, we performed a Principal Coordiante analysis with the proportions of each landuse type. 
- PCoA is more advisable given the nature of the data (sum up 100%, compositional data), we used gower distance tranformation to create a distance matrix among landscapes
