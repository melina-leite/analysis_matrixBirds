...
load(here("models_outputs","models_traits_nointeraction.Rdata")) # saved models results separate
```
...
jpeg(here("figures","forest_cover_coefs.jpg"), width=16, height = 10, units="cm", res=150)
fig.forest
dev.off()
```
