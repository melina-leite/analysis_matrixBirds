...
Processing and standardizing the data to create data for each bird assemblage (high and low-quality landscapes, forest specialists and habitat generalists).
...
Site information and local forest cover at different buffer radius (400m, 600m, 800m).
...
## Focal landscapes information

landscapes information with land use cover (%) from a buffer at 2 km radius around the centroid of the focal landscape.
...
Total richness for forest specialists and habitat generalists in each matrix quality type.
```{r}
...
Calculating beta diversity among regions of low and high-quality matrix landscapes. 
```{r}
data <- dataset %>% 
...
```{r, fig.cap="Beta diversity (all, turnover and nestedness) between assemblages in high- and low-quality matrix landscapes."}
