...
We ran separate models for each assemblage and trait. Afterwards, we ran one model with the combination of the traits body mass, diet, nest type and % of lower strata use. Table \ref{tab:tabr2} shows the marginal R^2^ of all models terms.
...
Example of the residual diagnostic of the model with the combined traits (main diet, body mass, nest type and % of lower strata use) for the forest specialists in high-quality matrix landscapes. The models' diagnostics for the other assemblages were all similar and can be checked in the Rmd file of the analysis repository.
